...
<body bgcolor="C5EEF9">
	<br>
	<center>
		<h1>Welcome To Owner Registration</h1>
	</center>
	<br>
			...
			<table align="center">
				...
				<tr>
					...
					<td align="left"><input type="number" name="mobilenumber"
						id="l1" placeholder="Enter mobile number "></td>
				</tr>
				<tr>
					<td align="right">Gender:</td>
					<td align="left"><input type="radio" name="gender"
						value="Male" id="l1">Male <input type="radio"
						name="gender" value="Female" id="l1">Female</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"><input type="date" name="date_of_joining"
						id="l1" placeholder="Enter date of your joining"></td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td align="left"><br>
					<br>Already registered? &nbsp<input type="button"
						value="Login" id="b1" onclick="location.href='owner_login.jsp'"></td>
				</tr>
			</table>
		</div>
	</form>
