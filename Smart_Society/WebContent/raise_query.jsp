			...
			<table align="center">
				...
				<tr>
					...
					<td align="left"><input type="email" name="owner_email"
						id="l1" value="<%=sgp.getEmailid()%>" readonly></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"><textarea rows="6" cols="38" name="query"
							id="l1" placeholder="query should be less than 500 characters"
							maxlength="500"></textarea></td>
				</tr>

				<td align="right"><input type="button" value="&#8592; back"
					id="b1" onclick="location.href='owner_home.jsp'"></td>
