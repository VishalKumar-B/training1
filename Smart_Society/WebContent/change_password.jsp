			...
			<table align="center">
				...
				<tr>
					...
					<td align="left"><input type="password"
						name="old_admin_password" id="l1" placeholder="Enter old password"></td>
				</tr>
				<tr>
					<td align="right">New Password:</td>
					<td align="left"><input type="password"
						name="new_admin_password" id="l1" placeholder="Enter new password"></td>
				</tr>
				<tr>
					<td align="right">Confirm New Password:</td>
					<td align="left"><input type="password"
						name="new_admin_password_confirm" id="l1"
