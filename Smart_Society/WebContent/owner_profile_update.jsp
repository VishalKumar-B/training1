...
<body bgcolor="C5EEF9">
	...
	<br>
	<form action="./OwnerProfileUpdateController" method="post"
		align="center">
		<div class="myDiv">
			<br>
			<table align="center">
			...
			,java.util.ArrayList,java.util.List"%>
				...
				<tr>
					...
					<td align="left"><input type="text" name="mobilenumber"
						id="l1" value="<%=sgp.getMobilenumber()%>"></td>
				</tr>
				<tr>
					<td align="right">Password:</td>
					<td align="left"><input type="password" name="password"
						id="l1" placeholder="Enter password to update"></td>
				</tr>
				<tr>
					<td align="right"><input type="button" value="&#8592; back"
						id="b1" onclick="location.href='owner_profile.jsp'"></td>
